...
import com.restful.api.service.BoardService;
...
public class BoardController {
    ...
    public SingleResult<Post> post(@PathVariable String boardName, @Valid @ModelAttribute PostDto post) {
    ...
    public SingleResult<Post> post(@PathVariable long postId, @Valid @ModelAttribute PostDto post) {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        String uid = authentication.getName();
